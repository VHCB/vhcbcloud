...
namespace DataAccessLayer
{
    ...
    {
        public static DataTable ProjectSearch(string ProjNum, string ProjectName, string AppNameID, string LKProgram, string LKProjectType, string Town,  string County)
        {
            DataTable dt = null;
            try
            {
