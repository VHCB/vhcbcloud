            ...
            <div class="container">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td style="width: 10%; float: left"><span class="labelClass">Trans From Date :</span></td>
                                <td style="width: 20%; float: left">
                                ...
                                <td style="width: 20%; float: left"><span class="labelClass">Trans End Date :</span></td>
                                <td style="width: 20%; float: left">
                            ...
                            <tr>
                                <td style="width: 10%; float: left; height: 56px;" colspan="6">
                                    <br />
                ...
                <asp:Panel ID="pnlTranDetails" runat="server" Visible="false">
                        <div class="panel panel-default">
                            ...
                            <br />
                            &nbsp;&nbsp;&nbsp;<asp:GridView ID="gvTransactions" runat="server" AutoGenerateColumns="false" Width="90%" CssClass="gridView"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-Width="150px" DataField="TransactionDate" HeaderText="Transaction Date" />
                                    <asp:BoundField ItemStyle-Width="150px" DataField="TransAmt" HeaderText="Amount" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
