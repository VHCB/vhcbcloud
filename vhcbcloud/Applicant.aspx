<%@ Page Title="Applicant" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Applicant.aspx.cs" Inherits="vhcbcloud.Applicant" %>
                    ...
                    <asp:Panel ID="pnlappl" runat="server" Visible="false">
                        ...
                        <table id="tblCorporate" runat="server" visible="false">
                            <tr style="float: left">
                                ...
                                <td>
                                    <asp:TextBox ID="txtApplicantName" CssClass="clsApplicantBlue" runat="server"></asp:TextBox>
                                    <ajaxToolkit:AutoCompleteExtender ID="aaceProjName" runat="server" TargetControlID="txtApplicantName" MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1"
                                        CompletionInterval="100" ServiceMethod="GetApplicantNames">
                            ...
                            <tr style="float: left">
                                ...
                                <td>
                                    <asp:TextBox ID="txtLName" CssClass="clsTextBoxBlue1" runat="server"></asp:TextBox>
                                     <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtLName" MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1"
                                        CompletionInterval="100" ServiceMethod="GetApplicantLastNames">
                                    </ajaxToolkit:AutoCompleteExtender>
                                </td>
                    ...
                    <p>
                        <asp:Panel runat="server" ID="Panel1" Width="100%" Height="350px" ScrollBars="Vertical">
                            <asp:GridView ID="gvApplicant" runat="server" AutoGenerateColumns="False"
                                ...
                                OnRowCancelingEdit="gvApplicant_RowCancelingEdit" OnRowEditing="gvApplicant_RowEditing" OnRowUpdating="gvApplicant_RowUpdating"
