...
@F17 int, @M17 int, @F30 int, @M30 int, @F50 int, @M50 int, @F51 int, @M51 int
...
select Primary_ASO_code as ProjectId, UUID, 
	...
	StartDate, Yr1, Yr2, Yr3, Primary_ASO, Primary_ASO_code, [Recent Living Situation] as RecentLivingSituation,
	...
	GMI, [% AMI] AMI, Beds, [Retained Hsg] as RetainedHsg, [Applied Sec 8] as AppliedSec8 , [Preference Status] as PreferenceStatus,
	[0-17 F] as F17, [0-17 M] as M17, [18-30F] as F30, [18-30 M] as M30, [31-50 F] as F50, [31-50 M] as M50, [51+ F] as F51, [51+ M] as M51
from [dbo].[MasterProj_2] mp
join dbo.HOPWA_RA_8 ra8(nolock) on mp.ProjectId = ra8.Primary_ASO_code
	...
	begin
		...
		LivingSituationId, SpecNeeds, GMI, AMI, Beds, Notes, PrimaryASO)
		select @ProjectId, @UUID, null, @withHIV, @InHousehold, @Minors, @HHGender, @HHAge, @HHEthnic, @HHRace, 
		@livingsituationID, @Special_Needs, @GMI, @AMI, @Beds, @PreferenceStatus, @PrimaryASO
	...
	select @HOPWAID, 26779, 201, @livingsituationID, @Yr1, @Yr2, @Yr3, @StartDate, null, null
