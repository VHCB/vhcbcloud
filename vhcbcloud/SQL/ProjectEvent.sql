...
if  exists (select * from sys.objects where object_id = object_id(N'[dbo].[AddProjectMilestone]') and type in (N'P', N'PC'))
drop procedure [dbo].AddProjectMilestone
go
...
if  exists (select * from sys.objects where object_id = object_id(N'[dbo].[UpdateProjectMilestone]') and type in (N'P', N'PC'))
drop procedure [dbo].UpdateProjectMilestone
go

create procedure dbo.UpdateProjectMilestone
(
	@ProjectEventID	int,
	@ApplicantID	int, 
	@EventID		int, 
