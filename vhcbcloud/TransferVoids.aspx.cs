        ...
        protected void ddlProjFilter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlProjFilter.SelectedIndex != 0)
            {
                ...
                else
                {
                    ...
                    DataRow dr = ProjectMaintenanceData.GetProjectNameById(ProjectNo);//FinancialTransactions.GetProjectNameByProjectNo(ProjectNo);
                    lblProjName.Text = dr["ProjectName"].ToString();
                }
            }
            else
            {
        ...
        protected void hdnValue_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    DataRow dr = ProjectMaintenanceData.GetProjectNameById(Convert.ToInt32(dt.Rows[0][0].ToString()));
                    lblProjName.Text = dr["ProjectName"].ToString();
                }
            }
            else
