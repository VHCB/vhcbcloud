<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProgressReport.aspx.cs" Inherits="vhcbcloud.Americorps.ProgressReport" %>
                                ...
                                <asp:Label runat="server" class="lblErrMsg" ID="lblQuestionAnswerErrorMsg"></asp:Label></td>
                                    ...
                                    <asp:DataPager ID="QuestionsListNextPrevious" runat="server"
                                        ...
                                        <Fields>
                                            ...
                                            &nbsp;&nbsp;<asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-info" Visible="false" OnClick="btnSubmit_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;
