<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Decommitments_old.aspx.cs" Inherits="vhcbcloud.Decommitments_old" %>
    ...
    <script type="text/javascript">
        ...
        function confirmExit() {
         ...
         function PopupAwardSummary() {
            window.open('./awardsummary.aspx?projectid=' + $("#<%= ddlProjFilter.ClientID%>  option:selected").val())
        };
