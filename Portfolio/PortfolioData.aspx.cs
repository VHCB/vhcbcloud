...
namespace Portfolio
{
    public partial class PortfolioData : System.Web.UI.Page
    {
        ...
        private void PopulateForm()
        {
            ...
            DataRow drPortfolioData = PortfolioDataData.GetPortfolioDataForOnLineApp(Session["UserId"].ToString(), projectNumber);
        ...
        private void Save()
        {
            PortfolioDataData.UpdateProjectPortfolio(DataUtils.GetInt(hfProjectPortfolioID.Value), DataUtils.GetInt(hfPortfolioType.Value), hfYear.Value.ToString(), DataUtils.GetInt(txtTotalUnits.Text),
