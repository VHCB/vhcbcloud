CREATE VIEW dbo.VW_RPT_Cons_PublicAccess
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConservePAccess.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_PublicAccess';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'lias = 2910
         Table = 1170
         Output = 720
         Append = 1400
         NewValue = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_PublicAccess';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         A', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_PublicAccess';
