CREATE VIEW dbo.VW_RPT_Cons_Acreage
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveAcres.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Acreage';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' Alias = 1950
         Table = 2625
         Output = 720
         Append = 1400
         NewValue = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Acreage';
