CREATE VIEW dbo.[VW_ALL_Financial Transactions]
AS
SELECT DISTINCT 
                      dbo.Trans.TransId, dbo.Trans.Correction, dbo.Detail.DetailID, dbo.Trans.ProjectID, dbo.VWLK_ProjectNames.Description AS [Project Name], dbo.Trans.Date, 
                      dbo.Trans.TransAmt, dbo.Trans.PayeeApplicant, dbo.Detail.FundId, dbo.Detail.Amount AS [Detail Amt], dbo.Trans.ProjectCheckReqID, dbo.Project.Proj_num, 
                      dbo.AppName.Applicantname AS Payee, dbo.VWLK_ApplicantName.Applicantname, dbo.VWLK_FinancialTransactionAction.Description AS [Transaction], 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_ALL_Financial Transactions';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_ALL_Financial Transactions';
