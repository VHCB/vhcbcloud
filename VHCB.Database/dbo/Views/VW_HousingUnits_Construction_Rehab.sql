CREATE VIEW dbo.VW_HousingUnits_Construction_Rehab
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_HousingUnits_Construction_Rehab';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'       Alias = 900
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_HousingUnits_Construction_Rehab';
