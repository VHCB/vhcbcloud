CREATE VIEW dbo.VW_RPT_Cons_Attrib
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveAttrib.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Attrib';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'idths = 11
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Attrib';
...
Begin DesignProperties = 
   ...
   End
   Begin CriteriaPane = 
      Begin ColumnW', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Attrib';
