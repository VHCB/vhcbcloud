CREATE VIEW dbo.VW_RPT_Cons_Approvals
AS
SELECT     dbo.Conserve.ProjectID, dbo.Project.Proj_num AS [Project Number], dbo.VWLK_ProjectNames.Description AS [Project Name], 
                      dbo.LookupValues.Description AS Violation, LookupValues_1.Description AS Disposition, dbo.ConserveApproval.ConserveApprovalID, dbo.ConserveApproval.ReqDate,
                       dbo.ConserveApproval.DispDate, dbo.ConserveApproval.Comments AS Expr1, dbo.ConserveApproval.URL AS Expr2
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveApproval.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Approvals';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'        Width = 1500
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Approvals';
