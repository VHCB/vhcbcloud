CREATE VIEW dbo.VW_RPT_Cons_LegaInt
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveLegInterest.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_LegaInt';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'   Alias = 2700
         Table = 1170
         Output = 720
         Append = 1400
         NewValue = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_LegaInt';
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "LookupValues"
            ...
            TopColumn = 0
         End
         Begin Table = "ConserveLegInterest"
            Begin Extent = 
               Top = 156
               Left = 43
               Bottom = 264
