CREATE VIEW dbo.VW_Reallocations
AS
SELECT     TOP (100) PERCENT dbo.Trans.TransId, dbo.Trans.Date, dbo.Project.Proj_num, dbo.VWLK_ProjectNames.Description AS ProjectName, dbo.AppName.Applicantname, 
                      ...
                      dbo.VWLK_VHCBPrograms.Description AS Program
FROM         dbo.Project INNER JOIN
                      ...
                      dbo.VWLK_VHCBPrograms ON dbo.Project.LkProgram = dbo.VWLK_VHCBPrograms.TypeID
WHERE     (dbo.Trans.LkTransaction = 240)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_Reallocations';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' DisplayFlags = 280
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_Reallocations';
