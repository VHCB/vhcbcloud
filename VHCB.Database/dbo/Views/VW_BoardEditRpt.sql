CREATE VIEW dbo.[VW_BoardEditRpt]
AS
...
WHERE     (dbo.ProjectApplicant.LkApplicantRole = 358) AND (dbo.Detail.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_BoardEditRpt';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' DisplayFlags = 280
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_BoardEditRpt';
