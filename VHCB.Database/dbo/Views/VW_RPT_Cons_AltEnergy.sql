CREATE VIEW dbo.VW_RPT_Cons_AltEnergy
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveAltEnergy.RowIsActive = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_AltEnergy';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' Alias = 2565
         Table = 1170
         Output = 720
         Append = 1400
         NewValue = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_AltEnergy';
