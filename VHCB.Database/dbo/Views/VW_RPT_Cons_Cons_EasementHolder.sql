CREATE VIEW dbo.VW_RPT_Cons_Cons_EasementHolder
AS
...
WHERE     (dbo.VWLK_ProjectNames.DefName = 1) AND (dbo.ConserveEholder.RowIsActive = 1) AND (dbo.ApplicantAppName.DefName = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Cons_EasementHolder';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_RPT_Cons_Cons_EasementHolder';
