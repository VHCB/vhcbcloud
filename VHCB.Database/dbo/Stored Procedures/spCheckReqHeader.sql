...
SELECT     dbo.Project.Proj_num, dbo.LookupValues.Description AS Program, dbo.VWLK_ProjectNames.Description AS [Project Name], dbo.ProjectCheckReq.InitDate, 
                      ...
                      dbo.ProjectCheckReq.Voucher#, LookupValues_2.Description AS Status,  dbo.Trans.TransId, dbo.ProjectCheckReq.ProjectCheckReqID, dbo.ProjectCheckReq.Coordinator, dbo.ProjectCheckReq.CRDate, dbo.UserInfo.UserName,dbo.Trans.LkTransaction
...
WHERE     (dbo.ProjectCheckReq.ProjectCheckReqID=@PCRID and dbo.ProjectApplicant.Defapp = 1) and dbo.ApplicantAppName.DefName=1 and dbo.VWLK_ProjectNames.Defname=1 and dbo.trans.LkTransaction=236
END