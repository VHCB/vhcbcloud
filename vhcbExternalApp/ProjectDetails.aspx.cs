...
namespace vhcbExternalApp
{
    public partial class ProjectDetails : System.Web.UI.Page
    {
        ...
        private void LoadViabilityApplicationPage1()
        {
            if (projectNumber != "")
            {
                DataRow drPage1tDetails = ViabilityApplicationData.GetViabilityApplicationPage1(projectNumber);
                ...
                if (drPage1tDetails != null)
                {
                    ...
                    if (drPage1tDetails["PriorParticipation"].ToString().ToLower() == "yes")
                    {
        ...
        protected void rdBtnPriorParticipation_SelectedIndexChanged(object sender, EventArgs e)
        {
            if(rdBtnPriorParticipation.SelectedValue.ToLower() =="yes")
            {
                lblPrimeAdvisor.Visible = true;
                txtPrimeAdvisor.Visible = true;
            }
